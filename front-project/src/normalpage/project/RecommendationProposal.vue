<template>
  ...
  <div class="project-container">
    ...
    <div class="nav-buttons">
      <router-link class="nav-button active" :to="{ name: 'RecommendationProposal' }"
        >과제 제안서</router-link
      >
    ...
    <table class="posts-table">
      ...
      <tbody>
        <tr v-for="post in filteredPosts" :key="post.id" class="post-item">
          ...
          <td>
            <router-link
              :to="{ name: 'DetRecommendationProposal', params: { id: post.id } }"
...
const handleClick = async () => {
  if (isLoggedIn.value) {
    if (isAdmin.value) {
      router.push({ name: "WrDeRecommendationProposal" });
    } else {
...
<style scoped src="@/assets/style/fourthmenu/RePro.css"></style>