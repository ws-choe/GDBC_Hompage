...
const routes = [
  ...
  //회원 글쓰기 라우터
  {
    path: '/write/wrde/WrDeActivityPlan/:id',
    name: 'WrDeActivityPlan',
    component: WrDeActivityPlan
  },
  {
    path: '/write/wrde/WrDeCode/:id',
    name: 'WrDeCode',
    component: WrDeCode
  },
  {
    path: '/write/wrde/WrDeFinalReport/:id',
    name: 'WrDeFinalReport',
    component: WrDeFinalReport
  },
  {
    path: '/write/wrde/WrDePresentation/:id',
    name: 'WrDePresentation',
    component: WrDePresentation
  },
  {
    path: '/write/wrde/WrDeRecommendationProposal/:id',
