<template>
  ...
  <form @submit.prevent="handleSubmit">
    ...
    <div class="button-group">
      <router-link :to="{ name: 'DetActivityPlan' }"><button type="button" class="cancel-button">취소</button></router-link>
...
try {
  ...
  alert('게시물이 수정되었습니다.');
  router.push({ name: 'DetActivityPlan', params: { id: route.params.id } });
} catch (error) {
...
<style scoped src="@/assets/style/modstyle/Mod.css">
</style>
