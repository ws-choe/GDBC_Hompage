  ...
  <div class="project-container">
    ...
    <div class="search-container">
      ...
      <button @click="searchPosts" class="search-btn">
        ...
        >
          <path
            d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85zM12.5 6.5a6 6 0 1 1-12 0 6 6 0 0 1 12 0z"
          />
        </svg>
      </button>
      <!-- 글 쓰기 버튼 (관리자만) -->
    ...
    <table class="posts-table">
      ...
      <tbody>
        <tr v-for="post in filteredPosts" :key="post.id" class="post-item">
          ...
          <td>
            <router-link
              :to="{ name: 'DeModCourseReviews', params: { id: post.id } }"
