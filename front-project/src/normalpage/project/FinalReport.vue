<template>
  ...
  <div class="project-container">
         <h1 class="project-title">최종 보고서</h1>
         <div class="nav-buttons">
           ...
           <router-link class="nav-button active" :to="{ name: 'FinalReport' }">최종 보고서</router-link>
       ...
       <div class="search-write-container">
         <div class="search-container">
           ...
           <button @click="searchPosts" class="search-btn">
             <svg role="img" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" aria-labelledby="searchIconTitle" stroke="#406E43" stroke-width="2" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#406E43"> <title id="searchIconTitle">Search</title> <path d="M14.4121122,14.4121122 L20,20"/> <circle cx="10" cy="10" r="6"/> </svg>
           </button>
         </div>
 ...
 const handleClick = async () => {
   if (isLoggedIn.value) {
     if (isAdmin.value) {
       router.push({ name: 'WrDeFinalReport' });
     } else {
...
<style scoped src="@/assets/style/fourthmenu/FinalPr.css"></style>